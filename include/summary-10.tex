...
$!A$ is a \emph{theorem} and write~$\Proves !A$. If there is
!!a{derivation} of $\Gamma_0 \Sequent !A$ where every $!B$ in $\Gamma_0$ is
...
theorem} is proved by induction on the length of !!{derivation}s, showing
