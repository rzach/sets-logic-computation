...
\RequirePackage{amsthm,shadethm}
...
\hypersetup{linkcolor=dkleadbeater,citecolor=dkleadbeater}
...
%\vskip2cm\hskip-1cm\includegraphics{illustrations/Cover}
