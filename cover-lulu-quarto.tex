...
% Spine width: 37.622 Postscript points wide (1.327 cm) (157 px)
...
\setlength{\coverwidth}{1127.622bp}
\setlength{\spinewidth}{37.622bp}
...
\noindent\hfil\rotatebox{-90}{% make spine text readable when book is lying cover up
      \hbox to \coverheight{\hfil
          \huge\sffamily\bfseries\color{black}
            Sets, Logic, Computation\hfil F16\hspace{1cm}}}\hfil
\end{textblock*}
\newbox\adjust
% make front cover
